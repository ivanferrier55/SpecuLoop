...
"""WRAP Edge — A typed semantic relationship between nodes.

Edges carry relationship types (causes, increases, decreases, supports,
opposes, requires, etc.) with numeric weights that represent semantic forces.
"""
